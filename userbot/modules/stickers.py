...
KANGING_STR = [
    "Dengan kekuatan kang tiker...\nakan menyolong mu...",
    "Kang dullu ye hehehe...",
    "Pun 10 kang...",
    "We bungkus ye gayn...",
    "Jadi gini gayn...\nWe kang boleh?..",
    "Wait....\nkanger no jutsu\npooof!.",
    "Mmmmh so good (☉｡☉)!→\nKang then...",
    "Kang,kang aku sayang sekali\nKang teros... ",
]
...
async def kang(args):
    ...
    if photo:
        ...
        await args.edit(f"`Tiker hasil kang dah beres di bungkus!`\
            \nSaya gelar di [mari](t.me/addstickers/{packname})",
                        parse_mode='md')
